...
public:
    // Touch events (called from render thread)
    // 接收完整的 MotionEvent 数据：actionMasked、pointerCount、每个手指的 x/y/id
    virtual void processTouchEvent(int actionMasked, int pointerCount,
